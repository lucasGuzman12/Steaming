...
Libros::Libros(QWidget *parent)
    : QWidget(parent)
{
    setObjectName("libros");
    ...
    QLabel *titulo = new QLabel("Libros recomendados");
    ...
    QFrame *recomendacionPrincipal = crearHero(
        ...
        "Fantasia, misterio y una narracion muy atrapante. Una buena opcion si queres una historia con aventura, magia y mucho foco en el personaje principal.");
    ...
    recomendaciones->addWidget(crearCajaSecundaria("Fundacion"));
    recomendaciones->addWidget(crearCajaSecundaria("Dune"));
    recomendaciones->addWidget(crearCajaSecundaria("El Hobbit"));
    ...
    setWindowTitle("Steaming - Libros");
    setStyleSheet(
        "#libros { background: qlineargradient(x1:0, y1:1, x2:1, y2:0, stop:0 #ff3df2, stop:0.28 #68268a, stop:0.62 #16224a, stop:1 #070a12); font-family: Segoe UI, Arial; color: #e8f7ff; }"
        "QLabel { background: transparent; color: #e8f7ff; }"
        "#barraSuperior { background: #0b1020; border: 1px solid #263859; border-radius: 10px; }"
        "#bloqueLogoSuperior { background: #0b1020; color: #9dff00; border: 1px solid #9dff00; border-radius: 10px; font-size: 30px; font-weight: bold; padding: 0 12px; }"
        ...
        "#tarjetaPrincipal { background: #05070d; border: 1px solid #9dff00; border-radius: 14px; }"
        ...
        "#etiquetaPrincipal { color: #ff3df2; font-size: 13px; font-weight: bold; }"
        "#tituloPrincipal { color: #9dff00; font-size: 34px; font-weight: bold; }"
