    ...
    : QWidget(parent)
{
    ...
    QLabel *titulo = new QLabel("Videos recomendados");
    ...
    QFrame *recomendacionPrincipal = crearHero(
        ...
        "Un video ideal para pensar como se construyen buenas experiencias. Recomendado si te interesa el diseno, las decisiones creativas y los sistemas interactivos."
    );
    ...
    recomendaciones->addWidget(crearCajaSecundaria("Game Maker's Toolkit"));
    recomendaciones->addWidget(crearCajaSecundaria("Kurzgesagt"));
    recomendaciones->addWidget(crearCajaSecundaria("Veritasium"));
    ...
    setWindowTitle("Steaming - Videos");
    setStyleSheet(
        "#videos { background: qlineargradient(x1:0, y1:1, x2:1, y2:0, stop:0 #ff3df2, stop:0.28 #68268a, stop:0.62 #16224a, stop:1 #070a12); font-family: Segoe UI, Arial; color: #e8f7ff; }"
