    ...
    : QWidget(parent)
{
    ...
    QLabel *titulo = new QLabel("Peliculas recomendadas");
    ...
    QFrame *recomendacionPrincipal = crearHero(
        "Dune: Parte Dos",
        "Ciencia ficcion epica con una gran puesta visual. Una recomendacion fuerte si buscas politica, accion, mundos enormes y una atmosfera intensa."
    );
    ...
    recomendaciones->addWidget(crearCajaSecundaria("Interestelar"));
    recomendaciones->addWidget(crearCajaSecundaria("El Origen"));
    recomendaciones->addWidget(crearCajaSecundaria("Matrix"));
    ...
    setWindowTitle("Steaming - Peliculas");
    setStyleSheet(
        "#peliculas { background: qlineargradient(x1:0, y1:1, x2:1, y2:0, stop:0 #ff3df2, stop:0.28 #68268a, stop:0.62 #16224a, stop:1 #070a12); font-family: Segoe UI, Arial; color: #e8f7ff; }"
        "QLabel { background: transparent; color: #e8f7ff; }"
        "#barraSuperior { background: #0b1020; border: 1px solid #263859; border-radius: 10px; }"
        "#bloqueLogoSuperior { background: #0b1020; color: #ff3df2; border: 1px solid #ff3df2; border-radius: 10px; font-size: 30px; font-weight: bold; padding: 0 12px; }"
        "#bloqueLogoSuperior:hover { background: #151f35; color: #00e5ff; border: 1px solid #00e5ff; }"
        ...
        "#tarjetaPrincipal { background: #05070d; border: 1px solid #ff3df2; border-radius: 14px; }"
        ...
        "#tituloPrincipal { color: #ff3df2; font-size: 34px; font-weight: bold; }"
        ...
        "#tarjetaSecundaria:hover { border: 1px solid #00e5ff; }"
        ...
        "QPushButton { background: #161f33; color: #e8f7ff; border: 1px solid #00e5ff; border-radius: 7px; padding: 8px 12px; font-weight: bold; }"
        "QPushButton:hover { background: #00e5ff; color: #070a12; border: 1px solid #ff3df2; }"
