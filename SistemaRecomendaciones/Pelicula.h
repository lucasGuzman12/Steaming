...
// Representa una pelicula recomendada o encontrada en TMDB.
#include <QJsonObject>
#include <QString>
using namespace std;

// Modelo simple para trasladar peliculas entre servicios, cache y UI.
class Pelicula
{
public:
    Pelicula(
    ...
    // Serializa la pelicula en un objeto JSON compatible con la interfaz.
