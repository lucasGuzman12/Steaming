...
// Representa un juego recomendado o recuperado desde Steam con los datos que
// la app necesita para mostrarlo y serializarlo.
#include <QJsonObject>
#include <QString>
using namespace std;

// Modelo liviano para transportar informacion de juegos dentro del proyecto.
class Juego
{
public:
    Juego(
    ...
    // Convierte el juego a JSON para integrarlo facilmente con la UI.
